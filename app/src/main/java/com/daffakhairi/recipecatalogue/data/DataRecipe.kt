package com.daffakhairi.recipecatalogue.data
...
object DataRecipe {
    ...
    get() {
        ...
        for (data in nameBreakfast.indices){
    ...
    get() {
        val list = arrayListOf<Recipes>()
        for (data in nameDessert.indices){
            val dessert = Recipes(
    ...
    val listVegetariant : ArrayList<Recipes>
    get() {
        val list = arrayListOf<Recipes>()
        for (data in nameVegetarian.indices){
            val vegetariant = Recipes(
